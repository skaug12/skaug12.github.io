...
여기에 하나를 더했다. 팀을 다음 시즌으로 옮길 때 원래 자리에 복사본을 남긴다. 옮기는 게 아니라 복제하고 옮기는 것이다.

이게 지난 시즌이 사라지는 걸 막았다. 지금은 몇 년 전 팀들의 페이지가 그대로 있다.

기록을 남기는 일은 대개 나중에 하려고 하면 안 하게 된다. 만드는 흐름 안에 넣어야 남는다.

## 따라 해보기

주기적으로 갱신하는 자료가 있다면, 갱신 전에 지금 상태를 복사해 두는 단계를 흐름의 맨 앞에 넣으면 된다. 나중에 백업하겠다는 계획은 대개 지켜지지 않는다.
