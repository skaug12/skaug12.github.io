...
멤버 한 사람이 평균 몇 번 등록하는지를 연도별로 세어 봤다. 충성도를 보고 싶었다.
...
나쁜 숫자는 대개 알아서 눈에 띈다. 위험한 건 좋아 보이는 숫자 쪽이다. 좋아 보이면 아무도 왜 좋아졌는지 안 물어본다.

## 따라 해보기

지금 잘 나오고 있는 지표를 하나 골라, 그 숫자가 올라가는 경로를 두 가지 이상 적어보면 된다. 하나가 나쁜 소식인 경로면, 그 지표는 혼자 보면 안 되는 지표다.
